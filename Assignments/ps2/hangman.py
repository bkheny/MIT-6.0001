...
#Assign secret word to random word from word list
        ...
        if guess.isalpha():
            ...
            if (guess in letters_guessed):
                if num_warnings > 0:
                    ...
                    num_guesses += -1
                print('Oops! That letter has been already guessed. You have', num_warnings, 'warnings left:', get_guessed_word(secret_word, letters_guessed))
                print('------------')
                continue
            else:
...
def match_with_gaps(my_word, other_word):
    ...
    if len(my_word) != len(other_word):
        return False
    for i in other_word:
        if (my_word[count] != i) and (my_word[count] != '_'):
            return False
        if (my_word[count] == '_') and i in my_word:
            return False
        count += 1
    return True
